...
public class TurnstileCommand implements CommandExecutor {
    ...
    private static void sendSetupHelp(Player player) {
        ...
        player.sendMessage("§2/"+command+" free (Name) [TimeStart]-[TimeEnd]§b Free during timespan");
        player.sendMessage("§2/"+command+" locked (Name) [TimeStart]-[TimeEnd]§b Locked for timespan");
